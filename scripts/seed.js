...
(() => {
  ...
  const quotes = [
    ...
    { id: id(), text: 'You will be free, but free in a vacuum.', bookTitle: '1984', bookAuthor: 'George Orwell', bookId: owned[3].id, page: '256', createdAt: now - 80*DAY },
    { id: id(), text: 'History is something very few people have been doing while everyone else was ploughing fields.', bookTitle: 'Sapiens', bookAuthor: 'Yuval Noah Harari', bookId: owned[4].id, page: '110', createdAt: now - 65*DAY },
    { id: id(), text: 'So we beat on, boats against the current, borne back ceaselessly into the past.', bookTitle: 'The Great Gatsby', bookAuthor: 'F. Scott Fitzgerald', bookId: owned[5].id, page: '180', createdAt: now - 46*DAY },
    { id: id(), text: 'Fear is the mind-killer.', bookTitle: 'Dune', bookAuthor: 'Frank Herbert', bookId: owned[6].id, page: '8', createdAt: now - 30*DAY },
    { id: id(), text: 'I must not fear. Fear is the little-death that brings total obliteration.', bookTitle: 'Dune', bookAuthor: 'Frank Herbert', bookId: owned[6].id, page: '8', createdAt: now - 29*DAY },
    ...
    { id: id(), text: 'If you only read the books that everyone else is reading, you can only think what everyone else is thinking.', bookTitle: 'Norwegian Wood', bookAuthor: 'Haruki Murakami', bookId: owned[7].id, page: '60', createdAt: now - 20*DAY },
    ...
    { id: id(), text: 'You don\'t have to be perfect to be a work of art.', bookTitle: 'Kafka on the Shore', bookAuthor: 'Haruki Murakami', bookId: owned[8].id, page: '210', createdAt: now - 11*DAY },
    ...
    { id: id(), text: 'You do not rise to the level of your goals. You fall to the level of your systems.', bookTitle: 'Atomic Habits', bookAuthor: 'James Clear', bookId: owned[10].id, page: '27', createdAt: now - 5*DAY },
    ...
    { id: id(), text: 'Some humans want a friend, but they don\'t want a friend who can see them too clearly.', bookTitle: 'Klara and the Sun', bookAuthor: 'Kazuo Ishiguro', bookId: owned[11].id, page: '195', createdAt: now - 24*DAY },
    { id: id(), text: 'I had been thinking about it. About being a hero.', bookTitle: 'Project Hail Mary', bookAuthor: 'Andy Weir', bookId: owned[12].id, page: '402', createdAt: now - 185*DAY },
    { id: id(), text: 'You can love someone and still choose to say goodbye to them.', bookTitle: 'Educated', bookAuthor: 'Tara Westover', bookId: owned[13].id, page: '329', createdAt: now - 150*DAY },
    { id: id(), text: 'Nothing in life is as important as you think it is, while you are thinking about it.', bookTitle: 'Thinking, Fast and Slow', bookAuthor: 'Daniel Kahneman', bookId: owned[14].id, page: '402', createdAt: now - 108*DAY },
    ...
    { id: id(), text: 'Freeing yourself was one thing; claiming ownership of that freed self was another.', bookTitle: 'Beloved', bookAuthor: 'Toni Morrison', bookId: owned[16].id, page: '95', createdAt: now - 215*DAY },
    { id: id(), text: 'To live is to suffer, to survive is to find some meaning in the suffering.', bookTitle: 'Crime and Punishment', bookAuthor: 'Fyodor Dostoyevsky', bookId: owned[17].id, page: '120', createdAt: now - 280*DAY },
    { id: id(), text: 'In the universe, an idea that goes against natural laws is doomed.', bookTitle: 'The Three-Body Problem', bookAuthor: 'Liu Cixin', bookId: owned[18].id, page: '305', createdAt: now - 235*DAY },
    { id: id(), text: 'It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife.', bookTitle: 'Pride and Prejudice', bookAuthor: 'Jane Austen', bookId: owned[19].id, page: '1', createdAt: now - 330*DAY },
