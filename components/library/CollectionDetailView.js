...
// Illustration multi-tons de l'empty state d'une collection sans livres (tokens
// --illus, viewBox 60). Exportée pour le Design System (Iconography).
export function CollectionDetailEmptyIcon() {
  return (
