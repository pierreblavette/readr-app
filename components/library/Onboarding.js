...
export function WordsIcon() {
  return (
    <svg width="120" height="120" viewBox="0 0 60 60" fill="none" aria-hidden="true">
      ...
      <path d="M34 21C40.6274 21 46 26.3726 46 33C46 39.6274 40.6274 45 34 45C27.3726 45 22 39.6274 22 33C22 26.3726 27.3726 21 34 21ZM34 24C29.0295 24 25 28.0294 25 33C25 37.9706 29.0295 42 34 42C38.9706 42 43 37.9706 43 33C43 28.0294 38.9706 24 34 24Z" fill="#6F7CF2"/>
      ...
      <path d="M29 33L35 33" stroke="#4959E6" strokeLinecap="round"/>
      ...
      <path d="M12 13H20V8C20 7.17595 19.0592 6.70557 18.4 7.2L16.15 8.8875C16.0611 8.95417 15.9389 8.95417 15.85 8.8875L13.6 7.2C12.9408 6.70557 12 7.17595 12 8V13Z" fill="#6F7CF2" stroke="#131860" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
