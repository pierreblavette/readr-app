  ...
  return (
    ...
    >
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <p className="ds-note">Les vignettes montrent la <strong>branche de repli</strong> du composant (dégradé <code>coverColors(title)</code> + initiale). Le vrai chip va chercher la couverture par titre/auteur ; la doc ne déclenche volontairement aucun appel réseau — elle resterait sinon dépendante d&apos;un quota d&apos;API pour s&apos;afficher deux fois pareil.</p>
        </div>
      </div>
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">.book-chip-name · titre + auteur</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">.book-chip-chevron · affordance</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">.book-chip-remove · action</div>
      ...
      <div className="ds-card">
        <div className="ds-card-head">Modes — ce qui les déclenche</div>
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <div className="ds-token-name">Aucune prop d&apos;action → Display</div>
            <p>Rendu en <code>&lt;div&gt;</code>, non focusable. C&apos;est le mode par défaut.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">onClick → Interactive</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">onRemove → With remove</div>
            <p>Ajoute la croix à droite. <strong>Mutuellement exclusif avec onClick</strong> : un bouton dans un bouton est un markup invalide, et l&apos;utilisateur ne saurait pas laquelle des deux actions il déclenche.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">rating (1–5) → étoiles</div>
            <p>Ajoute <code>.overview-stars</code> sous le nom, 14×14, remplies <span className="ds-token-chip">--primary-50</span> / vides <span className="ds-token-chip">--border</span>. Se combine avec les autres modes.</p>
          </div>
        </div>
      </div>

      <div className="ds-card">
        <div className="ds-card-head">Surcharges contextuelles</div>
        <div className="ds-card-body col">
          <div className="ds-token-block">
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">Dans .quote-card · aplati</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">Avec étoiles · alignement haut</div>
            <p><code>.book-chip:has(.overview-stars)</code> passe en <code>align-items: flex-start</code> : la vignette se cale en haut au lieu de flotter au centre d&apos;un bloc devenu plus haut. Le chevron, lui, garde son <code>align-self: center</code>.</p>
          </div>
        </div>
      </div>
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <p><code>components/library/BookChip.js</code>. La couverture est résolue par titre/auteur avec cache local, et retombe sur le dégradé + initiale si aucune image n&apos;est trouvée.</p>
          </div>
        </div>
      </div>
    </DSSection>
