    ...
    >
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          ...
          <p className="ds-note">Une citation enregistrée : le texte entre <span className="ds-class">.quote-mark</span> (accent), sa date, la rangée d&apos;actions (<em>Edit</em> · <em>Loved</em> actif · <em>Share</em>), le livre d&apos;origine en <a href="/ds/book-chip"><strong>Book Row</strong></a>, et <em>Delete</em>. Même coquille détachée (radius 8 + ombre) que <a href="/ds/panel"><strong>Side Panel</strong></a> ; en prod <code>fixed</code>, dockée au bord droit, slide-in.</p>
        </div>
      </div>
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            ...
            <p>Même coquille que <a href="/ds/panel"><strong>Side Panel</strong></a> : slide-in <code>translateX</code> <code>0.55s cubic-bezier(0.16, 1, 0.3, 1)</code>, <span className="ds-class">useModalA11y</span> (<code>Escape</code> + focus trap + restauration), scroll-lock du body, safe-area insets. Rien de re-décrit ici — voir Side Panel.</p>
          </div>
          <div className="ds-token-block">
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            ...
            <p>Contrepartie « citation » de <a href="/ds/panel"><strong>Side Panel</strong></a> (le livre). Même primitive <span className="ds-class">.book-panel</span>, partagée aussi avec <a href="/ds/filters/panel"><strong>Filters Panel</strong></a> et les List Panels — futur regroupement en famille <strong>Panels</strong>.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">Consumer</div>
            <p><code>QuotePanel</code>, ouvert au clic sur une citation (vue Quotes, listes de citations de l&apos;Overview). <code>onEdit</code>, <code>onToggleSave</code>, <code>onOpenBook</code>, <code>onDelete</code> remontent au parent ; <span className="ds-class">.book-chip</span> ouvre le <a href="/ds/panel"><strong>Side Panel</strong></a> du livre.</p>
          </div>
        </div>
      </div>
