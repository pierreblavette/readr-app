...
export const NAV = {
  ...
  Components: ["badges", "book-card-kebab", "book-chip", "buttons", "card", "checkbox", "chip", "dropdown", "empty", "footer", "inputs", "panel", "quote-panel", "rating-stars", "segmented-pills", "toggle"],
