  ...
  return (
    ...
    >
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <p className="ds-note">Rendu <code>position: static</code> pour la doc. En usage réel le menu est portalisé sur <code>document.body</code> (<code>position: fixed</code>) et positionné sous son déclencheur — voir <strong>Book Card Kebab</strong> pour le cycle ouverture/fermeture d&apos;un consommateur.</p>
        </div>
      </div>

      <div className="ds-card">
        <div className="ds-card-head">Item — états</div>
        <div className="ds-card-body col">
          <div className="ds-states-grid ds-states-grid--boxed">
      ...
      <div className="ds-card">
        <div className="ds-card-head">Anatomy — item (.dropdown-item)</div>
        <div className="ds-card-body col">
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <div className="ds-token-name">.dropdown-item</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">Radius 6 — rayons imbriqués</div>
            <p>6 = radius du menu (10) moins son padding (4) : deux courbes concentriques ne se lisent parallèles que si leur écart vaut l&apos;espace qui les sépare. La pastille de hover épouse alors le coin du menu sans le déborder.</p>
          </div>
        </div>
      </div>

      <div className="ds-card">
        <div className="ds-card-head">Anatomy — conteneur (.dropdown-menu)</div>
        <div className="ds-card-body col">
          {/* Redline sur le conteneur : les bandes montrent le padding 4 (gauche/
              droite). Items empilés verticalement → aucune bande de gap parasite. */}
          <div className="ds-redline-board">
            <Redline>
              <div className="dropdown-menu dropdown-menu--portal ds-menu-static" role="menu">
                <button type="button" className="dropdown-item">Mark as finished</button>
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <div className="ds-token-name">.dropdown-menu</div>
            <p>Padding <strong>4</strong> sur les 4 côtés (les bandes roses montrent le retrait entre le bord et les items), radius 10, border 1.5 <span className="ds-token-chip">--border-subtle</span>, ombre portée. <code>width: fit-content</code>, gabarit minimal 180 en usage.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">Contrat des listes flottantes — 10 / 4 / 6</div>
          ...
          <div className="ds-token-block">
            <div className="ds-token-name">.dropdown-divider</div>
      ...
      <div className="ds-card">
        <div className="ds-card-head">Consommateurs</div>
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <p>Le déclencheur, le positionnement et les items dépendent du contexte : <strong>Book Card Kebab</strong> (trigger trois points, items selon l&apos;état du livre), <strong>Export Menu</strong>, <strong>Sort Menu</strong>, <strong>Filters</strong>. Tous montent le même <code>.dropdown-menu</code> / <code>.dropdown-item</code> ; seule change la liste d&apos;actions.</p>
          </div>
        </div>
      </div>
    </DSSection>
