        ...
        <div className="ds-card-body col">
          <table className="token-table ds-anno-table">
            ...
            <tbody className="table-body">
              ...
              <tr className="table-row"><td>4</td><td><span className="ds-class">.col-card-kebab</span></td><td>Menu d&apos;actions 40×40 (partagé book / quote / dictionary / collection) — voir <span className="ds-class">Kebab</span>. Masqué en edit mode.</td><td><span className="now-reading-date now-reading-date--sm">Yes</span></td></tr>
            </tbody>
          </table>
        </div>
      </div>
