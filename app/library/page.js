    ...
    <footer className="library-footer">
      <div className="library-footer-inner">
        ...
        <span className="footer-links-desktop footer-section">
          <span className="footer-group">
            <a className="footer-link" href="/design-system">Design system</a>
          </span>
          <span className="footer-group">
            <a className="footer-link" href="https://pierreblavette.com" target="_blank" rel="noopener">© 2026 Pierre Blavette</a>
