    ...
    <footer className="library-footer" style={{ width }}>
      <div className="library-footer-inner">
        ...
        <span className="footer-links-desktop footer-section" style={{ width: "100%", justifyContent: "space-between" }}>
          ...
          <span className="footer-group">
            <a className="footer-link" href="#">© 2026 Pierre Blavette</a>
        ...
        <div className="ds-card-body col">
          <table className="token-table ds-anno-table">
            ...
            <tbody className="table-body">
              ...
              <tr className="table-row"><td>4</td><td><span className="ds-class">.footer-link</span></td><td>Lien (anchor ou button) : <code>13 / 500</code> <span className="ds-token-chip">--text-2</span>, hover <span className="ds-token-chip">--primary-50</span>. Groupés en <span className="ds-class">.footer-group</span> (gap 16).</td><td>—</td></tr>
            </tbody>
          </table>
        </div>
      </div>
        ...
        <div className="ds-card-body col">
          <div className="ds-redline-board ds-redline-board--lined">
            <div className="ds-redline-row ds-redline-row--fill" style={{ gridTemplateColumns: "1fr" }}>
              <Redline noGaps>
                <div className="library-footer-inner" style={{ width: "100%", padding: "20px 40px", fontSize: 13, fontWeight: 500, color: "var(--text-3)" }}>
                  <span className="footer-section">
        ...
        <div className="ds-card-body col">
          <div className="ds-redline-board ds-redline-board--lined">
            <div className="ds-redline-row" style={{ gridTemplateColumns: "1fr" }}>
              <Redline>
                <div className="library-footer-inner" style={{ width: 440, flexDirection: "column", alignItems: "stretch", gap: 16, padding: "20px 16px", fontSize: 13, fontWeight: 500, color: "var(--text-3)" }}>
                  <span className="footer-section" style={{ width: "100%", justifyContent: "space-between" }}>
                    <span className="footer-group"><button type="button" className="footer-link">How it works</button></span>
                    <div className="lang-toggle"><button type="button" className="lang-btn active">EN</button><span className="lang-sep">·</span><button type="button" className="lang-btn">FR</button></div>
                  </span>
          ...
          <p className="ds-note">En pile : la coquille garde son <strong>20</strong> vertical, l&apos;inner passe à <strong>16</strong> latéral (vs 40 desktop), et sépare les 3 sections d&apos;un gap colonne fixe de <strong>16</strong>. Cotes mesurées à l&apos;exécution.</p>
        </div>
        <div className="ds-card-body col">
          <div className="ds-token-block">
            <div className="ds-token-name">≤ 812px — profil scindé</div>
            <p>La section profil descend sur sa propre ligne (flex-wrap de l&apos;inner) : <span className="ds-class">.footer-links-desktop</span> passe pleine largeur + <code>space-between</code>. Ses deux <span className="ds-class">.footer-group</span> se séparent — <strong>Design system</strong> à gauche, <strong>copyright + LinkedIn</strong> à droite. Au-dessus de 812, la section reste compacte à droite dans le <code>space-between</code> des 3 sections.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">≤ 600px — colonne</div>
            <p>L&apos;inner passe en <code>flex-direction: column</code>, <code>align-items: stretch</code>, gap <code>16</code>. Chaque <span className="ds-class">.footer-section</span> prend toute la largeur en <code>space-between</code> — produit en haut, app au milieu, profil en bas.</p>
          </div>
          <div className="ds-token-block">
            <div className="ds-token-name">Liens en icônes</div>
            <p>Le copyright « © 2026 Pierre Blavette » est <strong>lui-même le lien</strong> vers le portfolio (nouvel onglet) — plus d&apos;icône ni de lien séparé. À sa droite, LinkedIn reste une icône (<code>18px</code> en mobile) ; « Design system » est un lien texte, à gauche.</p>
          </div>
        </div>
      </div>
      ...
      <div className="ds-card">
        ...
        <div className="ds-card-body col">
          <div className="ds-token-block">
            ...
            <p><strong>Produit</strong> (gauche) — « How it works » (rouvre l&apos;onboarding) + le switcher de langue. <strong>App</strong> (centre) — rappel privacy « Your data stays on this device » + version. <strong>Profil</strong> — <span className="ds-class">Design system</span> à gauche ; copyright (lien portfolio) + LinkedIn à droite.</p>
          </div>
          <div className="ds-token-block">
