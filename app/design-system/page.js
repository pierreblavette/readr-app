            ...
            <div className="ds-card">
              ...
              <div className="ds-card-body col padded">
                <table className="token-table">
                  <thead className="table-head"><tr><th>Element</th><th>Role</th><th>Specs</th></tr></thead>
                  <tbody className="table-body">
                    <tr className="table-row"><td className="token-table-component"><code>.col-card-kebab</code></td><td className="meta">Trigger (3 dots) — ghost pattern (aligned on <code>.btn-icon</code>)</td><td className="mono">40×40 · radius 8 · bg transparent · hover bg <span className="ds-token-chip">--primary-5</span> · color <span className="ds-token-chip">--text</span> → <span className="ds-token-chip">--primary-50</span> light / <span className="ds-token-chip">--primary-40</span> dark · svg 18×18 · in <code>.list-row</code> adds <code>display: inline-flex</code> for <code>text-align: right</code> push</td></tr>
          ...
          <DSSection id="card" title="Book Card" sub="Visual primitive for a single book — cover + title + author + meta. Same surface + hover family as BookPanel, NowReadingCard, BookChip.">
            ...
            <div className="ds-card">
              ...
              <div className="ds-card-body col">
                ...
                <div className="ds-token-block">
                  <div className="ds-token-name">Body padding (asymmetric)</div>
                  <p><code>.book-body</code> uses <code>padding: 8px 8px 16px 16px</code> — right reduced to 8 to pull the kebab close to the right edge of the card. <code>.book-body-info</code> adds <code>padding-top: 8</code> to drop the text below the kebab's top.</p>
                </div>
                <div className="ds-token-block">
                  <div className="ds-token-name">Meta truncation</div>
                  <p><code>.book-meta</code> is <code>display: block</code> with <code>white-space: nowrap</code> + <code>text-overflow: ellipsis</code> — long genre · year strings collapse to "…" instead of overflowing. The <code>·</code> separator carries its own <code>margin: 0 6px</code> (no flex gap).</p>
                </div>
              </div>
            </div>
          </DSSection>
...
function handleDeleteConfirm(payload) {
  ...
  return deleteBook(payload.id);
          ...
          {/* ── EMPTY STATE ── */}
          <DSSection id="empty" title="Empty State" sub="Gap-driven layout. Two flavours: full-page (icon 96×96, vertical centered, CTA) and mini inside .overview-card. Mini variant used by 7 Overview cards — vertical centered + icon 72 (Reading Goal, Reading Streak, Weekly Activity) or horizontal left-aligned + icon 60 (Top Genres, Top Authors, Most Loved, Quotes Spotlight). Reading Goal and Reading Streak carry a CTA; the rest are passive.">
              ...
              <div className="ds-card-body" style={{ gap: 32, flexWrap: "wrap", justifyContent: "flex-start" }}>
                ...
                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M14 40H51C47 43 47 49 51 52H14C10.6863 52 8 49.3137 8 46C8 42.6863 10.6863 40 14 40Z" fill="var(--illus-bg-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M24.5 39C20.3579 39 17 42.3579 17 46.5C17 50.6421 20.3579 54 24.5 54H14.5C10.3579 54 7 50.6421 7 46.5C7 42.3579 10.3579 39 14.5 39H24.5Z" fill="var(--illus-bg-3)"/>
                    <path d="M14 42H52C53.1046 42 54 41.1046 54 40C54 38.8954 53.1046 38 52 38H14C9.58172 38 6 41.5817 6 46C6 50.4183 9.58172 54 14 54H52C53.1046 54 54 53.1046 54 52C54 50.8954 53.1046 50 52 50H14C11.7909 50 10 48.2091 10 46C10 43.7909 11.7909 42 14 42Z" fill="var(--illus-accent-1)"/>
                    <path d="M37 38H14C9.58172 38 6 41.5817 6 46C6 50.4183 9.58172 54 14 54H52C53.1046 54 54 53.1046 54 52C54 50.8954 53.1046 50 52 50H14C11.7909 50 10 48.2091 10 46C10 43.7909 11.7909 42 14 42H52C53.1046 42 54 41.1046 54 40C54 38.8954 53.1046 38 52 38H43" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M46 24H9C13 27 13 33 9 36H46C49.3137 36 52 33.3137 52 30C52 26.6863 49.3137 24 46 24Z" fill="var(--illus-bg-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M35.5 23C39.6421 23 43 26.3579 43 30.5C43 34.6421 39.6421 38 35.5 38H45.5C49.6421 38 53 34.6421 53 30.5C53 26.3579 49.6421 23 45.5 23H35.5Z" fill="var(--illus-bg-3)"/>
                    <path d="M46 26H8C6.89543 26 6 25.1046 6 24C6 22.8954 6.89543 22 8 22H46C50.4183 22 54 25.5817 54 30C54 34.4183 50.4183 38 46 38H8C6.89543 38 6 37.1046 6 36C6 34.8954 6.89543 34 8 34H46C48.2091 34 50 32.2091 50 30C50 27.7909 48.2091 26 46 26Z" fill="var(--illus-bg-3)"/>
                    <path d="M22 26H46C48.2091 26 50 27.7909 50 30C50 32.2091 48.2091 34 46 34H8C6.89543 34 6 34.8954 6 36C6 37.1046 6.89543 38 8 38H46C50.4183 38 54 34.4183 54 30C54 25.5817 50.4183 22 46 22H8C6.89543 22 6 22.8954 6 24C6 25.1046 6.89543 26 8 26H16" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M40 11.8622C40 13.4087 39.4062 14.8941 38.3458 15.9929C35.9049 18.523 33.5374 21.1613 31.0053 23.5997C30.4249 24.1505 29.5042 24.1304 28.9488 23.5547L21.6538 15.9929C19.4487 13.7072 19.4487 10.0172 21.6538 7.73157C23.8804 5.42345 27.5079 5.42345 29.7346 7.73157C29.8794 7.88165 30.12 7.88182 30.2648 7.73173C31.3324 6.6245 32.7864 6 34.3053 6C35.8242 6 37.2781 6.62444 38.3458 7.73157C39.4063 8.83045 40 10.3158 40 11.8622Z" fill="var(--illus-accent-1)"/>
                ...
                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M10 10C10 7.79086 11.7909 6 14 6H48C49.1046 6 50 6.89543 50 8V52C50 53.1046 49.1046 54 48 54H14C11.7909 54 10 52.2091 10 50V10Z" fill="var(--illus-bg-2)"/>
                    ...
                    <path d="M36 50H44V55.5858C44 56.4767 42.9229 56.9229 42.2929 56.2929L40.1768 54.1768C40.0791 54.0791 39.9209 54.0791 39.8232 54.1768L37.7071 56.2929C37.0771 56.9229 36 56.4767 36 55.5858V50Z" fill="var(--illus-accent-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M29.9468 29.9693L7.45355 42.9541C5.25765 39.1403 4.00159 34.7168 4.00159 30C4.00159 15.659 15.6127 4.03098 29.9468 4.00186V29.9693Z" fill="var(--illus-bg-2)"/>
                    <path d="M30.0558 4.00186C44.3895 4.03155 56 15.6594 56 30C56 34.717 54.7431 39.1402 52.547 42.9541L30.0558 29.9693V4.00186Z" fill="var(--illus-mid)"/>
                    <path d="M52.492 43.0472C47.9897 50.7916 39.6041 55.9992 30.0008 55.9992C20.3973 55.9992 12.0108 50.7918 7.50858 43.0472L30.0008 30.0614L52.492 43.0472Z" fill="var(--illus-accent-1)"/>
                    <path d="M21.0877 5.56874C27.3681 3.28288 34.2874 3.50336 40.4095 6.18439C46.5316 8.86542 51.3861 13.8011 53.9652 19.9667C56.5444 26.1324 56.6501 33.0545 54.2604 39.2961C51.8708 45.5377 47.1693 50.6193 41.1319 53.486C35.0946 56.3527 28.1852 56.7844 21.838 54.6914C15.4907 52.5984 10.1933 48.1415 7.04537 42.2459C3.89742 36.3503 3.14075 29.4689 4.93243 23.0301C6.72411 16.5914 10.9265 11.0899 16.6673 7.66771" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M30.0008 4.00079L30.0233 29.987L52.5168 42.9996L30.0008 30.026L7.48482 42.9996L29.9783 29.987L30.0008 4.00079Z" stroke="var(--illus-stroke)"/>
                    <path d="M32 35C32 34.4477 32.4477 34 33 34H41C41.5523 34 42 34.4477 42 35V55C42 55.5523 41.5523 56 41 56H33C32.4477 56 32 55.5523 32 55L32 35Z" fill="var(--illus-bg-3)"/>
                    <path d="M20 42C20 41.4477 20.4477 41 21 41H29C29.5523 41 30 41.4477 30 42V55C30 55.5523 29.5523 56 29 56H21C20.4477 56 20 55.5523 20 55L20 42Z" fill="var(--illus-bg-2)"/>
                    <path d="M33 56H41C41.5523 56 42 55.5523 42 55L42 35C42 34.4477 41.5523 34 41 34H33C32.4477 34 32 34.4477 32 35V55C32 55.5523 32.4477 56 33 56Z" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M30 49L30 55C30 55.5523 29.5523 56 29 56L21 56C20.4477 56 20 55.5523 20 55L20 42C20 41.4477 20.4477 41 21 41L29 41C29.5523 41 30 41.4477 30 42L30 45" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M44 33C44 32.4477 44.4477 32 45 32H53C53.5523 32 54 32.4477 54 33V55C54 55.5523 53.5523 56 53 56H45C44.4477 56 44 55.5523 44 55V33Z" fill="var(--illus-accent-2)"/>
                    <path d="M54 48V33C54 32.4477 53.5523 32 53 32H45C44.4477 32 44 32.4477 44 33V55C44 55.5523 44.4477 56 45 56H53C53.5523 56 54 55.5523 54 55V52" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M25 48L37 41L49 45" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <circle cx="25" cy="48" r="2" fill="var(--illus-bg-3)" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <circle cx="37" cy="41" r="2" fill="var(--illus-accent-1)" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <circle cx="49" cy="45" r="2" fill="var(--illus-bg-2)" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                  </svg>
                ...
                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M36 44L7.99997 20V8H20L44 36L36 44Z" fill="var(--illus-bg-2)"/>
                    <path d="M17 17L7.99997 8L20 8.00003L44 36L40 40L34 34L33 33L31.5 31.5L23 23L17 17Z" fill="var(--illus-bg-3)"/>
                    <path d="M36 44L7.99997 20V8L20 8L44 36M17 17L19.5 19.5M34 34L21 21" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M42 48L48 42L53.5857 47.5858C54.3668 48.3668 54.3668 49.6331 53.5857 50.4142L50.4142 53.5858C49.6331 54.3668 48.3668 54.3668 47.5857 53.5858L42 48Z" fill="var(--illus-bg-3)"/>
                    <path d="M41.9998 48L43.9998 50L49.9998 44L47.9998 42L41.9998 48Z" fill="var(--illus-accent-1)"/>
                    <path d="M42 48L48 42L53.5857 47.5858C54.3668 48.3668 54.3668 49.6331 53.5857 50.4142L50.4142 53.5858C49.6331 54.3668 48.3668 54.3668 47.5857 53.5858L42 48Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M51 45L49 47" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M32.4142 45.5858L45.5857 32.4142C46.3668 31.6332 47.6331 31.6332 48.4142 32.4142L51.5857 35.5858C52.3668 36.3668 52.3668 37.6332 51.5857 38.4142L38.4141 51.5858C37.6331 52.3668 36.3668 52.3668 35.5857 51.5858L32.4142 48.4142C31.6331 47.6332 31.6331 46.3669 32.4142 45.5858Z" fill="var(--illus-accent-2)"/>
                    <path d="M47.9384 32.0621C47.1824 31.6601 46.2229 31.7777 45.5859 32.4147L32.414 45.5856C31.633 46.3666 31.6329 47.6336 32.414 48.4147L35.5859 51.5856C36.223 52.2227 37.1823 52.3394 37.9384 51.9371L33.707 47.7076C33.3164 47.3171 33.3164 46.6831 33.707 46.2926L47.9384 32.0621Z" fill="var(--illus-accent-1)"/>
                    <path d="M32.4142 45.5858L45.5857 32.4142C46.3668 31.6332 47.6331 31.6332 48.4142 32.4142L51.5857 35.5858C52.3668 36.3668 52.3668 37.6332 51.5857 38.4142L38.4141 51.5858C37.6331 52.3668 36.3668 52.3668 35.5857 51.5858L32.4142 48.4142C31.6331 47.6332 31.6331 46.3669 32.4142 45.5858Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M24 44L52 20V8H40L16 36L24 44Z" fill="var(--illus-bg-3)"/>
                    <path d="M43 17L52 8L40 8.00003L16 36L20 40L26 34L27 33L28.5 31.5L37 23L43 17Z" fill="var(--illus-bg-2)"/>
                    <path d="M24 44L52 20V8L40 8L16 36M43 17L30.5 29.5M26 34L28 32" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M18 48L12 42L6.41427 47.5858C5.63321 48.3668 5.63321 49.6331 6.41426 50.4142L9.58584 53.5858C10.3669 54.3668 11.6332 54.3668 12.4143 53.5858L18 48Z" fill="var(--illus-bg-3)"/>
                    <path d="M18.0002 48L16.0002 50L10.0002 44L12.0002 42L18.0002 48Z" fill="var(--illus-accent-1)"/>
                    <path d="M18 48L12 42L6.41427 47.5858C5.63321 48.3668 5.63321 49.6331 6.41426 50.4142L9.58584 53.5858C10.3669 54.3668 11.6332 54.3668 12.4143 53.5858L18 48Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M9.00002 45L11 47" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M27.5858 45.5858L14.4143 32.4142C13.6332 31.6332 12.3669 31.6332 11.5858 32.4142L8.41428 35.5858C7.63323 36.3668 7.63323 37.6332 8.41428 38.4142L21.5859 51.5858C22.3669 52.3668 23.6332 52.3668 24.4143 51.5858L27.5858 48.4142C28.3669 47.6332 28.3669 46.3669 27.5858 45.5858Z" fill="var(--illus-accent-2)"/>
                    <path d="M11.5859 32.4144C12.3669 31.6334 13.633 31.6334 14.414 32.4144L27.5859 45.5863C28.2226 46.2232 28.3392 47.1819 27.9374 47.9378L13.707 33.7074C13.3165 33.3168 12.6834 33.3168 12.2929 33.7074L8.06147 37.9378C7.66001 37.182 7.77756 36.2231 8.41401 35.5863L11.5859 32.4144Z" fill="var(--illus-accent-1)"/>
                    <path d="M27.5858 45.5858L14.4143 32.4142C13.6332 31.6332 12.3669 31.6332 11.5858 32.4142L8.41428 35.5858C7.63323 36.3668 7.63323 37.6332 8.41428 38.4142L21.5859 51.5858C22.3669 52.3668 23.6332 52.3668 24.4143 51.5858L27.5858 48.4142C28.3669 47.6332 28.3669 46.3669 27.5858 45.5858Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="panel-section-eyebrow">Genres</span>
                </div>

                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M5 55H16M50 55H20" stroke="var(--illus-mid)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M42.4346 43.2479L45.0001 27L33.0001 15L16.7521 17.5655C15.0982 17.8266 13.782 19.0902 13.4537 20.732L7.58841 50.0583C7.30852 51.4577 8.54236 52.6915 9.9418 52.4116L39.268 46.5464C40.9099 46.218 42.1735 44.9018 42.4346 43.2479Z" fill="var(--illus-bg-1)"/>
                    <path d="M42.4346 43.2479L45.0001 27L39.0001 21L9.33548 50.6646C8.63586 51.3642 9.26851 52.5463 10.2387 52.3523L39.268 46.5464C40.9099 46.218 42.1735 44.9018 42.4346 43.2479Z" fill="var(--illus-mid)"/>
                    <path d="M42.4346 43.2479L45.0001 27L33.0001 15L16.7521 17.5655C15.0982 17.8266 13.782 19.0902 13.4537 20.732L7.58841 50.0583C7.30852 51.4577 8.54236 52.6915 9.9418 52.4116L39.268 46.5464C40.9099 46.218 42.1735 44.9018 42.4346 43.2479Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M5.00006 55L25.0001 35" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M32.4142 14.4142L45.5858 27.5858C46.3668 28.3668 47.6332 28.3668 48.4142 27.5858L54.5858 21.4142C55.3668 20.6332 55.3668 19.3668 54.5858 18.5858L41.4142 5.41421C40.6332 4.63316 39.3668 4.63316 38.5858 5.41421L32.4142 11.5858C31.6332 12.3668 31.6332 13.6331 32.4142 14.4142Z" fill="var(--illus-accent-2)"/>
                    <path d="M42.4142 8.4144C41.6331 7.63336 40.3671 7.63338 39.586 8.4144L33.4142 14.5853C33.2699 14.7296 33.1536 14.8916 33.0626 15.0628L32.4142 14.4144C31.6331 13.6333 31.6331 12.3663 32.4142 11.5853L38.586 5.4144C39.3671 4.63338 40.6331 4.63336 41.4142 5.4144L54.586 18.5853C55.2228 19.2221 55.3401 20.1819 54.9386 20.9378L42.4142 8.4144Z" fill="var(--illus-accent-1)"/>
                    <path d="M32.4142 14.4142L45.5858 27.5858C46.3668 28.3668 47.6332 28.3668 48.4142 27.5858L54.5858 21.4142C55.3668 20.6332 55.3668 19.3668 54.5858 18.5858L41.4142 5.41421C40.6332 4.63316 39.3668 4.63316 38.5858 5.41421L32.4142 11.5858C31.6332 12.3668 31.6332 13.6331 32.4142 14.4142Z" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="30.0001" cy="34" r="4" transform="rotate(-180 30.0001 34)" fill="var(--illus-accent-1)"/>
                    <circle cx="28.0001" cy="32" r="4" transform="rotate(-180 28.0001 32)" fill="var(--illus-bg-1)"/>
                    <circle cx="28.0001" cy="32" r="4" transform="rotate(-180 28.0001 32)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="panel-section-eyebrow">Authors</span>
                </div>

                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M10 10C10 7.79086 11.7909 6 14 6H48C49.1046 6 50 6.89543 50 8V52C50 53.1046 49.1046 54 48 54H14C11.7909 54 10 52.2091 10 50V10Z" fill="var(--illus-bg-2)"/>
                    <path d="M10 50C10 47.7909 11.7909 46 14 46H50V52C50 53.1046 49.1046 54 48 54H14C11.7909 54 10 52.2091 10 50Z" fill="var(--illus-bg-2)"/>
                    <path d="M21 46C18.7909 46 17 47.7909 17 50C17 52.2091 18.7909 54 21 54H14C11.7909 54 10 52.2091 10 50C10 47.7909 11.7909 46 14 46H21Z" fill="var(--illus-bg-3)"/>
                    <path d="M50 43V50C50 52.2091 48.2091 54 46 54H14C11.7909 54 10 52.2091 10 50M10 50V10C10 7.79086 11.7909 6 14 6L48 6C49.1046 6 50 6.89543 50 8V44C50 45.1046 49.1046 46 48 46H42M10 50C10 47.7909 11.7909 46 14 46H38" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M36 50H44V55.5858C44 56.4767 42.9229 56.9229 42.2929 56.2929L40.1768 54.1768C40.0791 54.0791 39.9209 54.0791 39.8232 54.1768L37.7071 56.2929C37.0771 56.9229 36 56.4767 36 55.5858V50Z" fill="var(--illus-accent-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M31.9994 19.4015C35.2019 16.1991 40.3944 16.1992 43.597 19.4015C46.7997 22.6041 46.7997 27.7974 43.597 31.0001L33.4135 41.1837C32.6324 41.9645 31.3663 41.9645 30.5853 41.1837L20.4017 31.0001C17.1991 27.7974 17.1991 22.6041 20.4017 19.4015C23.6043 16.1992 28.7968 16.1992 31.9994 19.4015Z" fill="var(--illus-accent-1)"/>
                    <path d="M29.9997 17.4021C33.2024 14.1995 38.3947 14.1994 41.5974 17.4021C44.8 20.6048 44.8 25.7971 41.5974 28.9998L31.4138 39.1833C30.6328 39.9644 29.3667 39.9643 28.5857 39.1833L18.4011 28.9998C15.1988 25.7972 15.1988 20.6047 18.4011 17.4021C21.6038 14.1994 26.7971 14.1994 29.9997 17.4021Z" fill="var(--illus-accent-1)"/>
                    <path d="M29.9994 17.4015L29.6459 17.755C29.8411 17.9503 30.1577 17.9503 30.3529 17.755L29.9994 17.4015ZM41.597 17.4015L41.9506 17.0479L41.9506 17.0479L41.597 17.4015ZM31.4135 39.1837L31.767 39.5373L31.767 39.5372L31.4135 39.1837ZM28.5853 39.1837L28.2318 39.5372L28.2318 39.5373L28.5853 39.1837ZM18.4017 17.4015L18.0482 17.0479L18.0482 17.0479L18.4017 17.4015ZM29.9994 17.4015L30.3529 17.755C33.3602 14.7479 38.2361 14.748 41.2435 17.755L41.597 17.4015L41.9506 17.0479C38.5527 13.6505 33.0437 13.6503 29.6458 17.0479L29.9994 17.4015ZM41.597 17.4015L41.2435 17.755C44.2509 20.7624 44.2509 25.6391 41.2435 28.6465L41.597 29.0001L41.9506 29.3536C45.3485 25.9557 45.3485 20.4458 41.9506 17.0479L41.597 17.4015ZM41.597 29.0001L41.2435 28.6465L31.0599 38.8301L31.4135 39.1837L31.767 39.5372L41.9506 29.3536L41.597 29.0001ZM31.4135 39.1837L31.0599 38.8301C30.4742 39.4157 29.5246 39.4157 28.9389 38.8301L28.5853 39.1837L28.2318 39.5373C29.2081 40.5134 30.7907 40.5133 31.767 39.5373L31.4135 39.1837ZM28.5853 39.1837L28.9389 38.8301L18.7553 28.6465L18.4017 29.0001L18.0482 29.3536L28.2318 39.5372L28.5853 39.1837ZM18.4017 29.0001L18.7553 28.6465C15.7479 25.6391 15.7479 20.7624 18.7553 17.755L18.4017 17.4015L18.0482 17.0479C14.6502 20.4458 14.6502 25.9557 18.0482 29.3536L18.4017 29.0001ZM18.4017 17.4015L18.7553 17.755C21.7626 14.748 26.6385 14.748 29.6459 17.755L29.9994 17.4015L30.3529 17.0479C26.9551 13.6503 21.4461 13.6504 18.0482 17.0479L18.4017 17.4015Z" fill="var(--illus-stroke)"/>
                    <path d="M18.5144 22.8033C18.5984 21.6025 19.0604 20.4591 19.8341 19.537C20.6078 18.6149 21.6536 17.9614 22.8216 17.6702" stroke="var(--illus-bg-1)" strokeLinecap="round"/>
                  </svg>
                  <span className="panel-section-eyebrow">Most loved</span>
                </div>
                ...
                <div className="ds-icon-tile">
                  ...
                  <span className="panel-section-eyebrow">Quotes spotlight</span>
                </div>

                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <circle cx="30" cy="30" r="26" fill="var(--illus-bg-3)"/>
                    <circle cx="30" cy="30" r="17" fill="var(--illus-bg-2)"/>
                    <circle cx="30" cy="30" r="8" fill="var(--illus-accent-1)"/>
                    <path d="M49.9172 46.7125C45.621 51.8324 39.5182 55.1013 32.8756 55.8405C26.2331 56.5797 19.5609 54.7325 14.2443 50.6823C8.92768 46.6321 5.37497 40.6901 4.32366 34.0897C3.27236 27.4893 4.80322 20.7376 8.59845 15.2361C12.3937 9.73456 18.1618 5.90588 24.7053 4.54482C31.2489 3.18376 38.0652 4.39487 43.7394 7.92674C49.4136 11.4586 53.5097 17.0399 55.1775 23.5121C56.8453 29.9842 55.9566 36.8501 52.696 42.6844" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M32.3659 13.1654C36.6478 13.7672 40.5394 15.978 43.2487 19.3477C45.9581 22.7175 47.2816 26.9931 46.9499 31.3042C46.6182 35.6154 44.6561 39.6381 41.4631 42.5537C38.2701 45.4694 34.0861 47.0587 29.7626 46.9983C25.4391 46.938 21.3011 45.2324 18.1908 42.2288C15.0804 39.2251 13.2315 35.1492 13.0203 30.8304C12.8091 26.5117 14.2515 22.2748 17.0539 18.9819C19.8563 15.6891 23.8081 13.5879 28.1051 13.1059" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M22.8096 33.507C21.9557 31.756 21.7699 29.7537 22.2872 27.8756C22.8046 25.9974 23.9894 24.3726 25.6195 23.3059C27.2496 22.2392 29.2129 21.8039 31.141 22.0818C33.0692 22.3596 34.8297 23.3315 36.0923 24.815C37.3549 26.2986 38.0328 28.1918 37.9988 30.1396C37.9648 32.0874 37.2212 33.9559 35.9076 35.3944C34.594 36.833 32.8007 37.7428 30.864 37.9532C28.9273 38.1636 26.9804 37.6601 25.3885 36.5372" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M50 10L40 20L38 12L48 2L50 10Z" fill="var(--illus-bg-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M50 10L40 20L48 22L58 12L50 10Z" fill="var(--illus-bg-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M46 14L40 20L38 12L44 6L46 14Z" fill="var(--illus-accent-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M43 17L41.5 11" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M46 14L40 20L48 22L54 16L46 14Z" fill="var(--illus-accent-2)" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M43 17L49 18.5" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M30 30L52 8" stroke="var(--illus-stroke)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M30 30L52 8" stroke="var(--illus-bg-3)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="panel-section-eyebrow">Reading goal</span>
                </div>

                <div className="ds-icon-tile">
                  <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                    <path d="M27.5546 3.88912C28.995 2.77639 31.005 2.77639 32.4454 3.88913L38.7864 8.78773L46.734 9.80767C48.5394 10.0394 49.9606 11.4606 50.1923 13.266L51.2123 21.2136L56.1109 27.5546C57.2236 28.995 57.2236 31.005 56.1109 32.4454L51.2123 38.7864L50.1923 46.734C49.9606 48.5394 48.5394 49.9606 46.734 50.1923L38.7864 51.2123L32.4454 56.1109C31.005 57.2236 28.995 57.2236 27.5546 56.1109L21.2136 51.2123L13.266 50.1923C11.4606 49.9606 10.0394 48.5394 9.80767 46.734L8.78773 38.7864L3.88912 32.4454C2.77639 31.005 2.77639 28.995 3.88913 27.5546L8.78773 21.2136L9.80767 13.266C10.0394 11.4606 11.4606 10.0394 13.266 9.80767L21.2136 8.78773L27.5546 3.88912Z" fill="var(--illus-mid)"/>
                    <path d="M5.39386 25.6068L3.88913 27.5546C2.77639 28.995 2.77639 31.005 3.88912 32.4454L8.78773 38.7864L9.80767 46.734C10.0394 48.5394 11.4606 49.9606 13.266 50.1923L21.2136 51.2123L27.5546 56.1109C28.995 57.2236 31.005 57.2236 32.4454 56.1109L38.7864 51.2123L46.734 50.1923C48.5394 49.9606 49.9606 48.5394 50.1923 46.734L51.2123 38.7864L56.1109 32.4454C57.2236 31.005 57.2236 28.995 56.1109 27.5546L51.2123 21.2136L50.1923 13.266C49.9606 11.4606 48.5394 10.0394 46.734 9.80767L38.7864 8.78773L32.4454 3.88913C31.005 2.77639 28.995 2.77639 27.5546 3.88912L21.2136 8.78773L13.266 9.80767C11.4606 10.0394 10.0394 11.4606 9.80767 13.266L8.78773 21.2136L7.09079 23.4102" stroke="var(--illus-stroke)" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="30" cy="30" r="20" fill="var(--illus-bg-2)"/>
                    <path d="M17.999 13.999C15.4879 17.3418 14 21.4972 14 26C14 37.0457 22.9543 46 34 46C38.5027 46 42.6572 44.5111 46 42C42.3511 46.8574 36.543 50 30 50C18.9543 50 10 41.0457 10 30C10 23.4571 13.1417 17.6479 17.999 13.999Z" fill="var(--illus-bg-3)"/>
                    <path d="M23.1596 11.2061C27.9398 9.46631 33.2033 9.61334 37.8788 11.6173C42.5544 13.6213 46.2907 17.3315 48.3273 21.993C50.3638 26.6545 50.5476 31.9169 48.8411 36.709C47.1347 41.5012 43.6664 45.4631 39.1419 47.7883C34.6175 50.1136 29.3771 50.6274 24.4872 49.2252C19.5974 47.8231 15.4255 44.6103 12.8208 40.2408C10.2161 35.8714 9.37421 30.6735 10.4666 25.7053C11.5589 20.737 14.5034 16.3717 18.7007 13.4977" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <ellipse cx="22" cy="27.5" rx="4" ry="2.5" fill="var(--illus-mid)"/>
                    <ellipse cx="38" cy="27.5" rx="4" ry="2.5" fill="var(--illus-mid)"/>
                    <path d="M35.5433 34.2961C35.7169 33.877 35.842 33.4406 35.9169 32.9954C35.9888 32.5679 36.0247 32.3542 35.8749 32.1771C35.7251 32 35.4834 32 35 32H25C24.5166 32 24.2749 32 24.1251 32.1771C23.9753 32.3542 24.0112 32.5679 24.0831 32.9954C24.158 33.4406 24.2831 33.877 24.4567 34.2961C24.7583 35.0241 25.2002 35.6855 25.7574 36.2426C26.3145 36.7998 26.9759 37.2418 27.7039 37.5433C28.4319 37.8448 29.2121 38 30 38C30.7879 38 31.5681 37.8448 32.2961 37.5433C33.0241 37.2418 33.6855 36.7998 34.2426 36.2426C34.7998 35.6855 35.2417 35.0241 35.5433 34.2961Z" fill="var(--illus-bg-3)"/>
                    <path d="M30 35C31.7296 35 33.2546 35.5263 34.1523 36.3271C33.6141 36.8436 32.9857 37.2572 32.2959 37.543C31.568 37.8445 30.7879 38 30 38C29.2121 38 28.432 37.8445 27.7041 37.543C27.014 37.2571 26.385 36.8439 25.8467 36.3271C26.7444 35.526 28.2701 35 30 35Z" fill="var(--illus-accent-1)"/>
                    <path d="M35.5433 34.2961C35.7169 33.877 35.842 33.4406 35.9169 32.9954C35.9888 32.5679 36.0247 32.3542 35.8749 32.1771C35.7251 32 35.4834 32 35 32H25C24.5166 32 24.2749 32 24.1251 32.1771C23.9753 32.3542 24.0112 32.5679 24.0831 32.9954C24.158 33.4406 24.2831 33.877 24.4567 34.2961C24.7583 35.0241 25.2002 35.6855 25.7574 36.2426C26.3145 36.7998 26.9759 37.2418 27.7039 37.5433C28.4319 37.8448 29.2121 38 30 38C30.7879 38 31.5681 37.8448 32.2961 37.5433C33.0241 37.2418 33.6855 36.7998 34.2426 36.2426C34.7998 35.6855 35.2417 35.0241 35.5433 34.2961Z" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M34 26C34 25.4696 34.2107 24.9609 34.5858 24.5858C34.9609 24.2107 35.4696 24 36 24C36.5304 24 37.0391 24.2107 37.4142 24.5858C37.7893 24.9609 38 25.4696 38 26" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M22 26C22 25.4696 22.2107 24.9609 22.5858 24.5858C22.9609 24.2107 23.4696 24 24 24C24.5304 24 25.0391 24.2107 25.4142 24.5858C25.7893 24.9609 26 25.4696 26 26" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                    <path d="M41.4805 2.2836L40.0475 5.74503M57.7164 18.5195L54.2555 19.9538M57.7164 41.4805L54.2549 40.0475M41.4805 57.7164L40.0475 54.2549M18.5195 57.7164L19.9538 54.2555M2.2836 41.4805L5.74503 40.0475M2.2836 18.5195L5.74447 19.9538M18.5195 2.2836L19.9538 5.74447" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                  </svg>
                  <span className="panel-section-eyebrow">Reading streak</span>
                </div>
              </div>
            </div>
            ...
            <div className="ds-card">
              <div className="ds-card-head">Mini variant — <code>.overview-card-empty</code> (7 consumers)</div>
              <div className="ds-card-body" style={{ gap: 16, flexWrap: "wrap" }}>
                <div className="overview-card overview-goal" style={{ flex: "1 1 100%", minWidth: 0 }}>
                  ...
                  <div className="empty overview-card-empty">
                    <div className="overview-card-empty-body">
                      ...
                      <div className="empty-text">
                        <p className="empty-title">Set a reading rhythm</p>
                        <p className="empty-sub">Pick a number of books you want to finish this year and watch your progress here.</p>
                      </div>
                    </div>
                    <button type="button" className="btn btn-md btn-secondary">Set a reading goal</button>
                  </div>
                </div>
                <div className="overview-card overview-streak" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Reading streak</span>
                  </div>
                  <div className="empty overview-card-empty">
                    <div className="overview-card-empty-body">
                      ...
                      <div className="empty-text">
                        <p className="empty-title">Your streak starts soon</p>
                        <p className="empty-sub">Start a book or save a quote — your reading days will line up here.</p>
                      </div>
                    </div>
                    <button type="button" className="btn btn-md btn-secondary">Add a book</button>
                  </div>
                </div>
                <div className="overview-card overview-activity" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Weekly activity</span>
                  </div>
                  <div className="empty overview-card-empty">
                    <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                      <path d="M29.9468 29.9693L7.45355 42.9541C5.25765 39.1403 4.00159 34.7168 4.00159 30C4.00159 15.659 15.6127 4.03098 29.9468 4.00186V29.9693Z" fill="var(--illus-bg-2)"/>
                      <path d="M30.0558 4.00186C44.3895 4.03155 56 15.6594 56 30C56 34.717 54.7431 39.1402 52.547 42.9541L30.0558 29.9693V4.00186Z" fill="var(--illus-mid)"/>
                      <path d="M52.492 43.0472C47.9897 50.7916 39.6041 55.9992 30.0008 55.9992C20.3973 55.9992 12.0108 50.7919 7.50858 43.0472L30.0008 30.0614L52.492 43.0472Z" fill="var(--illus-accent-1)"/>
                      <path d="M21.0877 5.56874C27.3681 3.28288 34.2874 3.50336 40.4095 6.18439C46.5316 8.86542 51.3861 13.8011 53.9652 19.9667C56.5444 26.1324 56.6501 33.0545 54.2604 39.2961C51.8708 45.5377 47.1693 50.6193 41.1319 53.486C35.0946 56.3527 28.1852 56.7844 21.838 54.6914C15.4907 52.5984 10.1933 48.1415 7.04537 42.2459C3.89742 36.3503 3.14075 29.4689 4.93243 23.0301C6.72411 16.5914 10.9265 11.0899 16.6673 7.66771" stroke="var(--illus-stroke)" strokeLinecap="round"/>
                      <path d="M30.0008 4.00079L30.0233 29.987L52.5168 42.9996L30.0008 30.026L7.48482 42.9996L29.9783 29.987L30.0008 4.00079Z" stroke="var(--illus-stroke)"/>
                      <path d="M32 35C32 34.4477 32.4477 34 33 34H41C41.5523 34 42 34.4477 42 35V55C42 55.5523 41.5523 56 41 56H33C32.4477 56 32 55.5523 32 55L32 35Z" fill="var(--illus-bg-3)"/>
                      <path d="M20 42C20 41.4477 20.4477 41 21 41H29C29.5523 41 30 41.4477 30 42V55C30 55.5523 29.5523 56 29 56H21C20.4477 56 20 55.5523 20 55L20 42Z" fill="var(--illus-bg-2)"/>
                    ...
                    <div className="empty-text">
                      <p className="empty-title">Your week will fill up here</p>
                      <p className="empty-sub">Each day of reading, every quote and every word will appear as a bar in this chart.</p>
                    </div>
                  </div>
                </div>
                <div className="overview-card overview-genres" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Top genres</span>
                  </div>
                  <div className="empty overview-card-empty">
                    <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                      <path d="M36 44L7.99997 20V8H20L44 36L36 44Z" fill="var(--illus-bg-2)"/>
                    ...
                    <div className="empty-text">
                      <p className="empty-title">Genres are taking shape</p>
                      <p className="empty-sub">Add books with a genre to start mapping your reading universe.</p>
                    </div>
                  </div>
                </div>
                <div className="overview-card overview-authors" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Top authors</span>
                  </div>
                  <div className="empty overview-card-empty">
                    <svg className="empty-icon" viewBox="0 0 60 60" fill="none">
                      <path d="M5 55H16M50 55H20" stroke="var(--illus-mid)" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <div className="empty-text">
                      <p className="empty-title">Authors will gather here</p>
                      <p className="empty-sub">Add a few books to see your favourite voices emerge.</p>
                    </div>
                  </div>
                </div>
                <div className="overview-card overview-loved" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Most loved</span>
                  </div>
                  <div className="empty overview-card-empty">
                    ...
                    <div className="empty-text">
                      <p className="empty-title">Favourites will shine here</p>
                      <p className="empty-sub">Finish a book and rate it 4★ or more to celebrate it here.</p>
                    </div>
                  </div>
                </div>
                <div className="overview-card overview-quotes" style={{ flex: "1 1 calc(50% - 8px)", minWidth: 0 }}>
                  <div className="overview-card-head">
                    <span className="panel-section-eyebrow">Quotes spotlight</span>
                  </div>
                  <div className="empty overview-card-empty">
                    ...
                    <div className="empty-text">
                      <p className="empty-title">Quotes will shine here</p>
                      <p className="empty-sub">Save a passage from any book to spotlight it here.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="ds-card-body col padded">
                <table className="token-table">
                  ...
                  <tbody className="table-body">
                    ...
                    <tr className="table-row"><td className="token-table-component"><code>.empty.overview-card-empty</code></td><td className="meta">Mini variant (inside <code>.overview-card</code>) — two layouts. <b>Default (horizontal)</b>: icon | text-block side-by-side, left-aligned. Used by Genres, Authors, Most Loved, Quotes Spotlight. <b>Vertical centered</b>: icon then text stacked, centered. Used by Reading Goal (+ CTA), Reading Streak (+ CTA), Weekly Activity via parent-scoped override. <b>Mobile (≤768px)</b>: all 7 cards collapse to vertical centered + icon 72.</td><td className="mono">Default: flex row, align center, text-align left, padding 12 / 0, gap 16, icon 60×60, text flex 1 (sub max-width none), title 16/600, sub 15 / line 1.5. Goal/Streak/Activity override: flex col, text-align center, icon 72×72, text-block align center, flex initial. Mobile: same vertical override applied universally. CTA (Goal + Streak) = <code>.btn-md.btn-secondary</code></td></tr>
                    <tr className="table-row"><td className="token-table-component"><code>.overview-card-empty-body</code></td><td className="meta">Wrapper around icon + text inside an empty state that carries a CTA (Goal, Streak). Lets the CTA sit below with a wider gap.</td><td className="mono">flex col, align center, gap 16. Parent gap bumps to 20 via <code>:has(.overview-card-empty-body)</code> — wrapper ↔ CTA spacing</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            ...
            <div className="ds-card">
              ...
              <div className="ds-card-body col">
                <table className="token-table">
                  <thead className="table-head"><tr><th>Element</th><th>Role</th><th>Specs</th></tr></thead>
                  <tbody className="table-body">
                    <tr className="table-row"><td className="token-table-component"><code>.ob-overlay</code></td><td className="meta">Backdrop — click outside to close</td><td className="mono">fixed inset 0, z-index 1000, bg rgba(30,35,80,0.30) (light) / rgba(0,0,0,0.55) (dark), overlayIn 0.4s ease-out</td></tr>
                    <tr className="table-row"><td className="token-table-component"><code>.ob-modal</code></td><td className="meta">Modal shell</td><td className="mono">max-width 640, mx 24, bg <span className="ds-token-chip">--card</span>, radius 16, shadow-lg, flex col, modalIn 0.8s</td></tr>
                  ...
                  <div className="library-footer-inner">
                    ...
                    <span className="footer-links-desktop footer-section">
                      ...
                      <span className="footer-group">
                        ...
                        <a className="footer-link" href="/design-system" aria-label="Design system">
              ...
              <div className="ds-card-body col">
                <table className="token-table">
                  ...
                  <tbody className="table-body">
                    ...
                    <tr className="table-row"><td className="token-table-component"><code>.library-footer-inner</code></td><td className="meta">Content row</td><td className="mono">padding 0 40, flex justify-between align-center, gap 16, flex-wrap. ≤780px → flex col stretch, gap clamp(16, 4vw, 24)</td></tr>
                    <tr className="table-row"><td className="token-table-component"><code>.footer-section</code></td><td className="meta">Each of the 3 sections (left / center / right)</td><td className="mono">flex row align-center, gap 16. ≤780px → width 100%, justify-between</td></tr>
                    <tr className="table-row"><td className="token-table-component"><code>.footer-group</code></td><td className="meta">Tight subgroup inside a section</td><td className="mono">inline-flex align-center, gap 16</td></tr>
                    ...
                    <tr className="table-row"><td className="token-table-component"><code>.footer-links-desktop</code></td><td className="meta">Right section wrapper (portfolio + LinkedIn + Design system)</td><td className="mono">Marker class — hidden on desktop-only contexts when relevant</td></tr>
